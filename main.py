...
class Game:
    ...
    def ProcessInput(self, command):
        if command.lower() in ["exit", "quit"]:
            ...
            return f"Processed command: {command}" # Anything else you want to do to the text
        return ''
    ...
    def run(self):
        ...
        while running:
                ...
                if event.type == pygame.QUIT:
                    ...
                    if event.key == pygame.K_RETURN:
                        ...
                        if processed_command:
                            ...
                            self.AddText(f'> {self.inputText}', self.inputColor)  # Display input
                            ...
                            self.AddText('> ', self.BLUE)  # New line for next input prompt without processing
            ...
            self.textLines[-1] = (f'> {self.inputText}', self.inputColor)  # Update input line
            self.DisplayText()
